...
-- live in nix.lua, generated by modules/hyprland.nix.
--
...
-- by modules/hyprland.nix) via the workspace.library in .luarc.json.
--
-- Structure: each section is a named setup_* function; the call list at the
-- bottom is the table of contents.
-- nix.lua (generated by modules/hyprland.nix) does its env/plugin side
