...
- [PipeWire Configuration](#pipewire-configuration)
  ...
  - [Troubleshooting](#troubleshooting) - [Check current settings](#check-current-settings) - [List audio devices](#list-audio-devices) - [Check if USB autosuspend is disabled (should be -1)](#check-if-usb-autosuspend-is-disabled-should-be-1)
  <!--toc:end-->
