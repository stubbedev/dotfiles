...
vim.keymap.set("n", "<leader>be", "<cmd>enew<cr>", { desc = "New window buffer" })
vim.keymap.set("n", "<leader>bv", "<cmd>vnew<cr>", { desc = "New vertical buffer" })
vim.keymap.set("n", "<leader>bh", "<cmd>new<cr>", { desc = "New horizontal buffer" })
