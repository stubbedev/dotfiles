...
{
  flake.modules.homeManager.setupPlymouthTheme =
    (import ../../../lib/activation-setups.nix).mkSudoSetupModule
      (
        {
          name = "setupPlymouthTheme";
        }
        // {
          ...
          args =
            ...
            homeLib.mkInstallPrompt {
              ...
              actionScript = ''
                ...
                if command -v apt-get >/dev/null 2>&1; then
                  ...
                  ${homeLib.installSystemFile {
                    ...
                    content = ''
                      ...
                      # modules/activation/privileged/setup-plymouth-theme.nix
                ...
                # and plymouth-quit-wait.service only blocks on plymouth's exit —
