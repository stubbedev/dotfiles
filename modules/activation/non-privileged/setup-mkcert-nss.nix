...
{
  flake.modules.homeManager.setupMkcertNss =
    (import ../../../lib/activation-setups.nix).mkSetupModule
      (
        ...
        // {
          ...
          #
          # On non-NixOS, modules/activation/privileged/setup-mkcert-trust.nix runs
          ...
          # gated off on NixOS (lib/activation-setups.nix mkSudoSetupModule only runs
          ...
          # no sudo is needed; this lives in modules/activation/non-privileged. TRUST_STORES=nss tells
