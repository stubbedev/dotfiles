...
{ inputs, ... }:
{
  flake.modules.homeManager.nvim =
    ...
    let
      ...
      languages = [
        "bash" "blade" "c" "caddy" "comment" "css" "diff" "dockerfile"
        "git_rebase" "gitcommit" "go" "gomod" "gotmpl" "gowork" "hcl" "html"
        "javascript" "json" "just" "lua" "markdown" "markdown_inline" "nix"
        "php" "php_only" "phpdoc" "python" "query" "regex" "rust" "scss" "sql"
        "svelte" "templ" "toml" "tsx" "typescript" "vim" "vimdoc" "vue" "xml"
        "yaml"
      ];
